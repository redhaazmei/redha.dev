...
date: January 5 2020
description: Learn how to add authentication with Next.js. The guide covers custom React Hooks, protecting routes and redirecting on the server, and includes a variety of examples.
category: Web Development
image: /images/fetching-data-with-swr/banner.jpg
---
...
```jsx
const did = await new Magic(process.env.NEXT_PUBLIC_MAGIC_PUB_KEY).auth.loginWithMagicLink({ email: "your@email.com" });
